                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    @foreach($transaction as $trans)
                       <tr>
                       <td>{{ $no++ }}</td>
                        <td>SR{{ $trans->id_transaction }}</td>
                        <td>{{ $trans->ekspedition }}</td>
                        <td>
                        @if($trans->status_pembayaran == "belum lunas")
                    ...
                    <td>
                        <a href="{{ url('cart/detail/'.$trans->id_transaction) }}" class="btn btn-template-outlined btn-sm">Detail</a>
                    </td>
                    </tr>
                    @endforeach
                    </tbody>
