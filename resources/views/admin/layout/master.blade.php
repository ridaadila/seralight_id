...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>S</b>.ID</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Seralight</b>.ID</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              @else
              <img src="{{ asset('static/dist/img/' . Auth::user()->photo) }}" class="user-image" alt="User Image">
              @endif
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                @else
                <img src="{{ asset('static/dist/img/' . Auth::user()->photo) }}" class="img-circle" alt="User Image">
                @endif
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview ">
        ...
        {{-- <li><a href="#"> <i class="fa fa-folder"></i> <span>Media</span></a></li> --}}
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 Seralight.ID <a href="https://adminlte.io"></a>.</strong> All rights
    reserved.
  </footer>
