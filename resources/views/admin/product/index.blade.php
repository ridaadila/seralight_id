@extends('admin.layout.master')
  ...
  <title>Product - Seralight.ID</title>
	@endsection
	@section('body')
  <div class="row">
    <div class="col-md-12">
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>
                @if (isset($item->photo))
                <img src="{{ asset('static/dist/img/' . $item->photo) }}" width="50px">    
                @else
                <img src="{{ asset('static/dist/img/avatar5.png') }}" width="50px">
                @endif
              </td>
              ...
              <td>
                ...
                <a href="{{ url('admin/product/' .$item->id_product . '/edit')}}" class="btn btn-sm btn-primary">Edit</a>
